...
# Define the paths for the input images and output directory for cropped images
...
for img_filename in os.listdir(input_dir):
    ...
    h = width  # Set the height of the cropped region
    ...
    # Adjust annotations for the cropped image if it exists in the annotation file
    image_id = img_filename.split('.')[0]  # Assuming image ID matches filename without extension
