...
# Define color for Class 3 (e.g., Black or Gray)
CLASS_3_COLOR = (0, 0, 0)  # Black for Class 3
CIRCLE_RADIUS = 5  # Radius of the circles
CIRCLE_COLOR = (0, 0, 0)  # Black border for circles (you can use gray as (128, 128, 128))
CIRCLE_THICKNESS = 2  # Slightly thicker outline
...
output_dir = "F:/Pomodoro/Work/TIME/Script/Thesis-Abbas-Segmentation/PolygontoYOLO/ErrorPlayground/pore1" 
